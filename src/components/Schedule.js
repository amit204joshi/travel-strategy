                    ...
                    <div className="space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">东京➡️北海道</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">东京➡️北海道</h2>
                                <div className="mt-4">
                                    <img
                                        src={flightTo2}
                                        alt="FlightTo2"
                                ...
                                <h3 className="text-lg text-black mt-4">🛃入境攻略</h3>
                                <a
                                ...
                                <h3 className="text-lg text-black mt-4">✈️羽田机场T3转T2</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新千岁机场➡️札幌</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新千岁机场➡️札幌</h2>
                                <p className="text-gray-600 my-2">末班车23:21</p>
                                <div className="mt-4">
                                    <img
                                        src={jr1}
                                        alt="jr1"
                                ...
                                <h3 className="text-lg text-black mt-4">🚄新千岁机场直达札幌市区JR乘车攻略</h3>
                                <a
                                ...
                                <h3 className="text-lg text-black mt-4">🏨入住札幌万怡酒店</h3>
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">午餐</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">午餐</h2>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">札幌电视塔</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">札幌电视塔</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={zh1} alt="zh1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Rin'yū Morning Market"
                                ...
                                <h3 className="text-lg text-black mt-4">📸札幌电视塔机位攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">白色恋人公园</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">白色恋人公园</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={zh2} alt="zh2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Rin'yū Morning Market"
                                ...
                                <h3 className="text-lg text-black mt-4">📸白色恋人公园参观攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">狸小路商业街</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">狸小路商业街</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={zh3} alt="zh3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={zh4} alt="zh4" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <p className="text-gray-600 my-2">营业时间：10:00-20:00</p>
                                <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                    <iframe
                                        title="Otaru Canal"
                                ...
                                <h3 className="text-lg text-black mt-4">🚠狸小路购物攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">晚餐</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">晚餐</h2>
                            </div>
                        </div>
                    </div>
                </CollapsibleSection>
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">札幌➡️小樽</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">札幌➡️小樽</h2>
                                <div className="mt-4">
                                    <img src={jr2} alt="jr2" className="rounded-lg shadow-md w-full md:w-full h-auto" />
                                </div>
                                <p className="text-gray-600 my-2">提前一天去买指定席座位！靠车厢右边</p>
                                <div className="md:w-1/2">
                                    <img src={xz0} alt="xz0" className="rounded-lg shadow-md w-full h-auto" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">三角市场（车站旁）</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">三角市场（车站旁）</h2>
                                <div className="mt-4">
                                    <img src={site1} alt="site1" className="rounded-lg shadow-md w-full md:w-1/2 h-96" />
                                </div>
                                <h2 className="text-xl font-semibold text-gray-800 mt-4">鲮友朝市（本地人去）</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={site2} alt="site2" className="rounded-lg shadow-md w-full h-96" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Rin'yū Morning Market"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">小樽运河</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">小樽运河</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={xz1} alt="xz1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={xz2} alt="xz2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <p className="text-gray-600 my-2">13:30前往</p>
                                <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                    <iframe
                                        title="Otaru Canal"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">天狗山</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">天狗山</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={tgs1} alt="tgs1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={tgs2} alt="tgs2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <p className="text-gray-600 my-2">15:00前往</p>
                                <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                    <iframe
                                        title="Otaru Canal"
                                ...
                                <h3 className="text-lg text-black mt-4">🚠天狗山缆车攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">小樽➡️札幌</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">小樽➡️札幌</h2>
                                <div className="mt-4">
                                    <img src={jr3} alt="jr3" className="rounded-lg shadow-md w-full h-auto" />
                                </div>
                            </div>
                        </div>
                ...
                <CollapsibleSection id="day4" title={
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">午餐</h2>
                                <p className="text-gray-600 my-2">12:00前退房</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">札幌➡️登别</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">札幌➡️登别</h2>
                                <div className="mt-4">
                                    <img src={jr4} alt="jr4" className="rounded-lg shadow-md w-full h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">🏨入住第一潼本馆酒店</h3>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={hotel2} alt="hotel2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Rin'yū Morning Market"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">登别地狱谷</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">登别地狱谷</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={db1} alt="db1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Rin'yū Morning Market"
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">登别➡️新千岁机场</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">登别➡️新千岁机场</h2>
                                <p className="text-gray-600 my-2">10:00前退房</p>
                                <h3 className="text-lg text-black mt-4">道南巴士：登别温泉/第一潼本馆上车</h3>
                                <p className="text-red-500 my-2">提前一周在willer网站预约 or 提前一天登别温泉站买票</p>
                                <div className="mt-4">
                                    <img src={bus1} alt="bus1" className="rounded-lg shadow-md w-full md:w-2/3 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">🚌网上预约攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新千岁机场➡️东京</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新千岁机场➡️东京</h2>
                                <div className="mt-4">
                                    <img src={flightBack1} alt="flightBack1" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4 mb-2">羽田机场➡️市区: JR京急机场线 转 山手线</h3>
                                <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                    <iframe
                                        title="route1"
                                ...
                                <h3 className="text-lg text-black mt-4">🏨入住东京高田马场站前船舶酒店</h3>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={hotel3} alt="hotel3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Hotel3"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">Shibuya Sky展望台</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">Shibuya Sky展望台</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={dj1} alt="dj1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={dj2} alt="dj2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <p className="text-red-500 my-2">webket/klook买票！提前28天晚上十一点开始放票！16:00前往</p>
                                <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                    <iframe
                                        title="Otaru Canal"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">歌舞技町</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">歌舞技町</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={dj3} alt="dj3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="Otaru Canal"
                                ...
                                <h3 className="text-lg text-black mt-4">⚠️Tips</h3>
                                ...
                                <h3 className="text-lg text-black mt-4">✅正确玩法：のぞき部屋</h3>
                                <p className="text-gray-600 my-2">
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新宿➡️迪士尼</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新宿➡️迪士尼</h2>
                                <p className="text-gray-600 my-2">新宿巴士总站乘坐直达巴士，现场买票</p>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">游玩攻略</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">游玩攻略</h2>
                                <div className="mt-4">
                                    <img src={dy1} alt="dy1" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">⚠️Tips</h3>
                                <p className="text-gray-600 my-2">
                                ...
                                <div className="mt-4">
                                    <img src={dy2} alt="dy2" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">⚠️预约介绍</h3>
                                <p className="text-gray-600 my-2">
                                ...
                                <div className="mt-4">
                                    <img src={dy4} alt="dy4" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">🎇表演</h3>
                                <p className="text-gray-600 my-2">
                                    🩷巡游： 14:00和16:05<br />
                                    烟花灯光秀：19:15<br />
                                    💛动感大乐团~匠心小欢乐（ER）<br />
                                ...
                                <div className="mt-4">
                                    <img src={dy9} alt="dy9" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">美食攻略</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">美食攻略</h2>
                                <h3 className="text-lg text-black mt-4">美食地图</h3>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={dy5} alt="dy5" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={dy6} alt="dy6" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={dy7} alt="dy7" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2">
                                        <img src={dy8} alt="dy8" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <h3 className="text-lg text-black mt-4">🍿必吃榜</h3>
                                <p className="text-gray-600 my-2">
                                    🩷辣味烟熏鸡腿<br />
                                    🩷虾肉汉堡套餐<br />
                                    🩷提拉米苏三明治冰淇淋<br />
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">台场海滨公园(数码宝贝&天气之子)</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">台场海滨公园(数码宝贝&天气之子)</h2>
                                <h3 className="text-lg text-black mt-4">🗺️巡礼路线图</h3>
                                <div className="mt-4">
                                    <img src={sm0} alt="sm0" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <p className="text-gray-600 my-2">导航到新桥站。新桥站下车后，同站换乘海鸥线。买一个新桥到台场海滨公园。到站后就是A1点。</p>
                                <div className="mt-4 flex flex-row md:space-x-4">
                                    <div className="w-1/3">
                                        <img src={sm1} alt="sm1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={sm2} alt="sm2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={sm3} alt="sm3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <div className="mt-4 flex flex-row md:space-x-4">
                                    <div className="w-1/3">
                                        <img src={sm4} alt="sm4" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={sm5} alt="sm5" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={sm6} alt="sm6" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">参桥宫+新宿/须贺神社</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">参桥宫+新宿/须贺神社</h2>
                                <h3 className="text-lg text-black mt-4">🗺️秒速五厘米&言叶之庭&你的名字</h3>
                                <div className="mt-4">
                                    <img src={xl1} alt="xl1" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">📌具体位置</h3>
                                <a
                                ...
                                <div className="mt-4 flex flex-row md:space-x-4">
                                    <div className="w-1/3">
                                        <img src={xl2} alt="xl2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl3} alt="xl3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl4} alt="xl4" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <div className="mt-4 flex flex-row md:space-x-4">
                                    <div className="w-1/3">
                                        <img src={xl5} alt="xl5" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl6} alt="xl6" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl7} alt="xl7" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                                <div className="mt-4 flex flex-row md:space-x-4">
                                    <div className="w-1/3">
                                        <img src={xl8} alt="xl8" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl9} alt="xl9" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="w-1/3">
                                        <img src={xl10} alt="xl10" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">原宿-表参道/猫街道-南青山</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">原宿-表参道/猫街道-南青山</h2>
                                <h3 className="text-lg text-black mt-4">🗺️路线图</h3>
                                <div className="mt-4">
                                    <img src={dj4} alt="dj4" className="rounded-lg shadow-md w-full md:w-2/3 h-auto" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新宿-涩谷商场</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新宿-涩谷商场</h2>
                                <div className="mt-4">
                                    <img src={dj5} alt="dj5" className="rounded-lg shadow-md w-full md:w-1/2 h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">🛍️推荐商场</h3>
                                <div className="flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <h3 className="text-lg text-black mt-4">涩谷</h3>
                                        <p className="text-gray-600 my-2">
                                            1️⃣ 涩谷 109 <br />
                                    ...
                                    <div className="md:w-1/2">
                                        <h3 className="text-lg text-black mt-4">新宿</h3>
                                        <p className="text-gray-600 my-2">
                                            1️⃣ 伊势丹<br />
                    ...
                    <div className="space-y-12">
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新宿➡️河口湖</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新宿➡️河口湖</h2>
                                <p className="text-gray-600 my-2">11:00前退房</p>
                                <h3 className="text-lg text-black mt-4">巴士：ＢＵＳＴＡ新宿上车</h3>
                                <p className="text-red-500 my-2">查看富士山能见度，提前2天在highwaybus网站 or 提前一天现场买票</p>
                                <div className="mt-4">
                                    <img src={bus2} alt="bus2" className="rounded-lg shadow-md w-full h-auto" />
                                </div>
                                <h3 className="text-lg text-black mt-4">🚌网上预约攻略</h3>
                                <a
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">罗森便利店</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">罗森便利店</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={fss1} alt="fss1" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="sitels"
                                ...
                                <h3 className="text-lg text-black mt-4">线路图</h3>
                                <div className="md:w-1/2">
                                    <img src={fss4} alt="fss4" className="rounded-lg shadow-md w-full h-auto" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">河口湖畔</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">河口湖畔</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={fss2} alt="fss2" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="sitels"
                        ...
                        <div className="flex flex-col md:flex-row">
                            <div className="flex items-center md:flex-col md:items-center md:mr-4 mb-4 md:mb-0">
                                ...
                                <h2 className="md:hidden text-xl font-semibold text-gray-800">新仓浅间神社</h2>
                                <div className="hidden md:block md:flex-1 w-px bg-gray-300" />
                            </div>
                            <div className="flex-1">
                                <h2 className="hidden md:block text-xl font-semibold text-gray-800">新仓浅间神社</h2>
                                <div className="mt-4 flex flex-col md:flex-row md:space-x-4">
                                    <div className="md:w-1/2">
                                        <img src={fss3} alt="fss3" className="rounded-lg shadow-md w-full h-auto" />
                                    </div>
                                    <div className="md:w-1/2 mt-4 md:mt-0 w-full h-64 md:h-96">
                                        <iframe
                                            title="sitels"
